...
export const proj84to67 = (coord:number[])=>Proj4js("EPSG:4326","EPSG:3828").forward(coord)
export const proj67to84 = (coord:number[])=>Proj4js("EPSG:4326","EPSG:3828").inverse(coord)
