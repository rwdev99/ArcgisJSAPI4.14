var drawPolygon = (function (exports) {
    'use strict';
    ...
    */
    ...
    var loadModule = function (url) { return __awaiter$1(void 0, void 0, void 0, function () { return __generator$1(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, loadModules([url], { version: CONFIG.VERSION, css: true })];
    ...
    var DrawPolygon = /** @class */ (function (_super) {
        __extends$2(DrawPolygon, _super);
        ...
        DrawPolygon.prototype.load = function () {
        ...
        DrawPolygon.prototype._convertPolygon = function (polygon) {
            return __awaiter$4(this, void 0, void 0, function () {
                var prvPloygon, isCross;
                return __generator$4(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(polygon.rings[0].length > 3)) return [3 /*break*/, 3];
                            prvPloygon = polygon.clone();
                            prvPloygon.removePoint(0, polygon.rings[0].length - 1);
                            return [4 /*yield*/, this.Engine.overlaps(polygon, prvPloygon)];
                        case 1:
                            isCross = _a.sent();
                            if (!isCross) return [3 /*break*/, 3];
                            return [4 /*yield*/, this.Engine.simplify(polygon)];
                        case 2: return [2 /*return*/, _a.sent()];
                        case 3: return [2 /*return*/, polygon];
                    }
                });
            });
        };
        DrawPolygon.prototype._addGraphicToGlyr = function (geometry, timestamp) {
            return __awaiter$4(this, void 0, void 0, function () {
                var symbol;
                return __generator$4(this, function (_a) {
        ...
        DrawPolygon.prototype._addAndBuffGraphicToGlyr = function (geometry, timestamp) {
            return __awaiter$4(this, void 0, void 0, function () {
        ...
        DrawPolygon.prototype._setTipText = function (vertexIndex) {
            if (vertexIndex === 0)
                this.tipText.setText("單擊左鍵開始繪製，雙擊左鍵完成");
        ...
        DrawPolygon.prototype.clearGraphicsByTime = function (timestamp, type) {
            for (var _i = 0, _a = this.glyr.graphics.toArray(); _i < _a.length; _i++) {
                var graphic = _a[_i];
        ...
        DrawPolygon.prototype.draw = function () {
            var _this = this;
            // init
            ...
            this.drawAction.on('vertex-add', function (evt) { return __awaiter$4(_this, void 0, void 0, function () {
                var polygon, spolygon;
                return __generator$4(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this._convertPolygon(polygon)];
                        case 1:
                            spolygon = _a.sent();
                            this._setTipText(evt.vertexIndex);
                            this.clearGraphicsByTime(timestamp);
                            return [4 /*yield*/, this._addGraphicToGlyr(spolygon, timestamp)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            this.drawAction.on('draw-complete', function (evt) { return __awaiter$4(_this, void 0, void 0, function () {
                ...
                return __generator$4(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            return [4 /*yield*/, this._addAndBuffGraphicToGlyr(spolygon, timestamp)];
                        case 3:
                            _a.sent();
        ...
        DrawPolygon.prototype.sketch = function () {
            var _this = this;
            // init
            ...
            this.sketchViewModel.on("create", function (evt) {
                ...
                if (evt.state === "complete") {
                    uLastG = cLastGs.pop();
                    _this.sketchViewModel.update(uLastG, { tool: "reshape" });
                    cLastGs = [];
                    return;
                }
                if (evt.toolEventInfo.type === "vertex-add") {
                    ...
                    if (cLastGs.length > 2) { // 可構成面，交給使用者變形
                        _this.eventHub.emit("tipText", "拖動各圓點改變多邊形，點擊其他地方完成操作");
                        _this.sketchViewModel.complete();
                    }
                }
            });
            this.sketchViewModel.on("update", function (evt) { return __awaiter$4(_this, void 0, void 0, function () {
                var isCross;
                return __generator$4(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            isCross = false;
                            return [4 /*yield*/, this.Engine.overlaps(uLastG.geometry, evt.graphics[0].geometry)];
                        case 1:
                            isCross = _a.sent();
                            if (!isCross) {
        ...
        return __generator$4(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (drawPolygon)
                        return [2 /*return*/];
                    return [4 /*yield*/, new DrawPolygon(view, map).load()
                        // when finished ; emit "complete" event to "drawPolygon.eventHub" and must register event first
                    ];
                case 1:
                    drawPolygon = _a.sent();
                    // when finished ; emit "complete" event to "drawPolygon.eventHub" and must register event first
                    drawPolygon.eventHub.on('complete', function () { return __awaiter$4(void 0, void 0, void 0, function () {
                        var g, res, _a;
                        return __generator$4(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    g = drawPolygon.glyr.graphics.getItemAt(0).geometry;
                                    _a = {};
                                    return [4 /*yield*/, drawPolygon.Engine.geodesicArea(g, "hectares")];
                                case 1:
                                    _a.area_hectare = _b.sent();
                                    return [4 /*yield*/, drawPolygon.Engine.geodesicArea(g, "square-meters")];
                                case 2:
                                    _a.area_metric = _b.sent();
                                    return [4 /*yield*/, drawPolygon.Engine.geodesicLength(g, "meters")];
                                case 3:
                                    _a.length_metric = _b.sent();
                                    return [4 /*yield*/, drawPolygon.Engine.geodesicLength(g, "kilometers")];
                                case 4:
                                    res = (_a.length_kmetric = _b.sent(),
                                        _a);
                    ...
                    return [4 /*yield*/, drawPolygon.draw()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
                        ...
                        return __generator$4(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    drawPolygon.draw();
                                    return [4 /*yield*/, drawPolygon.getWkt()];
                                case 1:
                                    wktstr = _a.sent();
                                    console.log(wktstr);
                                    return [2 /*return*/];
    ...
    var setBuffer = function (buffer) { return drawPolygon.buffer = Number(buffer) || 0; };
