var DrawPoint = (function (exports) {
    ...
    */
    ...
    var proj84to97 = function (coord) { return proj4("EPSG:3826", "EPSG:3857").inverse(coord); };
        ...
        return __generator$4(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (drawPoint)
                        return [2 /*return*/];
                    return [4 /*yield*/, new DrawPoint(view, map).load()
                        ...
                        return __generator$4(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    drawPoint.draw();
                                    return [4 /*yield*/, drawPoint.getWkt()];
                                case 1:
                                    wktstr = _a.sent();
                                    console.log(wktstr);
                                    return [2 /*return*/];
