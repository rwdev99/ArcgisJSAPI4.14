var init = (function (exports) {
	...
	*/
	...
	var Init = /** @class */ (function () {
	    ...
	    // todo
	    Init.prototype.create3D = function (mapConfig, viewConfig) {
	        return __awaiter$2(this, void 0, void 0, function () {
	            var WEBSCENE_URL, Map, View;
	            return __generator$2(this, function (_a) {
	                switch (_a.label) {
	                    case 0:
	                        WEBSCENE_URL = mapConfig && ('portalItem' in mapConfig) ? "WebScene" : "Map";
	                        return [4 /*yield*/, loadModule("esri/" + WEBSCENE_URL)];
	                    case 1:
	                        Map = _a.sent();
	                        return [4 /*yield*/, loadModule("esri/views/SceneView")];
	                    case 2:
	                        View = _a.sent();
	                        this.map = new Map(mapConfig);
	                        this.view = new View(__assign(__assign({}, viewConfig), { map: this.map }));
	     ...
	     */
	    Init.prototype.setMapViewConstraintsScale = function (view, _a) {
	        var maxScale = _a.maxScale, minScale = _a.minScale;
	        if (maxScale)
	            view.constraints.maxScale = maxScale;
	        if (minScale)
	        ...
	        return __awaiter$2(this, void 0, void 0, function () {
	            ...
	            return __generator$2(this, function (_b) {
	                switch (_b.label) {
	                    ...
	                    case 1:
	                        _a = (_b.sent()).coords, latitude = _a.latitude, longitude = _a.longitude;
	                        return [2 /*return*/, [latitude, longitude]];
	                    case 2:
	                        e_2 = _b.sent();
	                        console.error("[ getGeoLocation fail ]", e_2);
	                        throw (e_2);
